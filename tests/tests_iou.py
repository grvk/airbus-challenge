...
class IoUTests(unittest.TestCase):
	...
	def test_one_img_one_class_match(self):
		...
		IoUTests.assert_ious_equal(iou, 1.0, prediction, mask, "mean iou")
		IoUTests.assert_ious_equal(ious, [None, 1.0], prediction, mask, "ious")
	...
	def test_two_imgs_two_classes_match(self):
		...
		IoUTests.assert_ious_equal(iou, 1.0, prediction, mask, "mean iou")
		IoUTests.assert_ious_equal(ious, [1.0, 1.0], prediction, mask, "ious")
	...
	def test_two_imgs_two_classes_one_img_wrong(self):
		...
		iou, ious = IntersectionOverUnion(prediction, mask)
		IoUTests.assert_ious_equal(iou, .5, prediction, mask, "mean iou")
		IoUTests.assert_ious_equal(ious, [.5, .5, 1], prediction, mask, "ious")
